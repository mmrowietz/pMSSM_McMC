...
#include"num_out.h"
#include"num_in.h"
extern FNN F108_a32a32_a10a10p1;
static void C108(REAL*V,REAL * C)
{
REAL S[10];                                                                 
...
C[17]=+S[4]*(V[33]*(V[34]*(V[3]*(V[12]*(S[2]+S[3])+2*V[30]*V[29]*V[3])+2*
 V[30]*V[29]*S[4])));
C[16]=+V[3]*(V[3]*(V[29]*(V[33]*(V[3]*(V[30]*(4*V[34]*V[3]+2*V[33]*V[14])+2*
 V[34]*V[29]*V[12])+2*V[34]*V[30]*S[4]+V[33]*V[29]*V[14]*V[12])+S[0]*(V[14]*
 (2*V[30]*V[3]+V[29]*V[12])))+S[2]*(V[12]*(V[14]*(S[0]+S[1])+2*V[34]*V[33]*
 V[3])))+S[4]*(V[14]*(V[29]*(V[30]*(S[0]+S[1])))))-2*V[34]*V[33]*V[30]*
 V[29]*S[5];
C[15]=+V[3]*(V[29]*(V[30]*(V[14]*(2*(S[0]+S[1]))+6*V[34]*V[33]*V[3])+V[34]*
 V[33]*V[29]*V[12])+V[34]*V[33]*S[2]*V[12]);
C[14]=+V[3]*(V[3]*(V[12]*(V[14]*(S[3]*(-S[0]-S[1])+S[2]*(-S[0]-S[1]))+V[3]*(
...
C[13]=+V[29]*(V[33]*(V[3]*(V[30]*(4*V[34]*V[3]+3*V[33]*V[14])+V[34]*V[29]*
 V[12])+2*V[33]*V[29]*V[14]*V[12]-4*V[34]*V[30]*S[4])+3*S[0]*V[30]*V[14]*
 V[3])+S[2]*(V[12]*(V[34]*(2*V[34]*V[14]+V[33]*V[3])));
C[12]=+V[12]*(V[33]*(S[3]*(V[34]*V[3]+V[33]*V[14])+V[34]*S[2]*V[3])+S[0]*
 S[2]*V[14])-4*V[34]*V[33]*V[30]*V[29]*S[4];
C[11]=+V[3]*(V[29]*(V[30]*(V[14]*(4*(S[0]+S[1]))+6*V[34]*V[33]*V[3])+V[34]*
 V[33]*V[29]*V[12])+V[34]*V[33]*S[2]*V[12])+V[12]*(V[14]*(2*(S[0]*S[2]+S[1]*
 S[3])));
C[10]=+V[29]*(V[30]*(V[3]*(V[14]*(2*(S[0]+S[1]))+4*V[34]*V[33]*V[3])+6*
 V[34]*V[33]*S[4]));
C[9]=+V[3]*(V[3]*(V[29]*(V[33]*(V[3]*(V[30]*(4*V[34]*V[3]+2*V[33]*V[14])+2*
 ...
 V[34]*V[33]*S[2]*V[12]));
C[8]=+V[3]*(V[29]*(V[30]*(V[14]*(S[0]+S[1])+8*V[34]*V[33]*V[3])+3*V[34]*
 V[33]*V[29]*V[12])+3*V[34]*V[33]*S[2]*V[12])+4*V[34]*V[33]*V[30]*V[29]*
 S[4];
C[7]=+V[3]*(V[29]*(V[30]*(V[14]*(S[0]+S[1])+2*V[34]*V[33]*V[3])));
C[6]=+V[3]*(V[29]*(V[30]*(V[14]*(S[0]+S[1])+4*V[34]*V[33]*V[3])+2*V[34]*
 V[33]*V[29]*V[12])+2*V[34]*V[33]*S[2]*V[12])+V[12]*(V[14]*(S[0]*S[2]+S[1]*
 S[3]));
C[5]=+V[3]*(2*(V[29]*(V[14]*(V[30]*(S[0]+S[1]))-V[34]*V[33]*V[29]*V[12])-
 V[34]*V[33]*S[2]*V[12]));
C[4]=+V[33]*(V[34]*(V[3]*(V[12]*(2*(S[2]+S[3]))+4*V[30]*V[29]*V[3])+2*V[30]*
 V[29]*S[4]));
...
REAL F108_a32a32_a10a10p1(double GG, REAL*V, REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*
 Q2,REAL*cb_coeff,int gsw,int gtw)
{
REAL N,D,R; COMPLEX Prop;
static REAL C[21];                                                          
     
if(!DP){C108(V,C); return 0;} 
  REAL N_p1p2_=1/DP[0];
N=-C[0];
D=+C[1];
