...
int main(int argc,char** argv)
{
	...
	if(!test_file(ISAJET)) 
	{
		printf("\"%s\" absent. Please check the ISAJET path or comment \"#define USE_ISAJET\" in cmssm.c\n",ISAJET);
		filesOK=0;
	}
#endif
#ifdef USE_SOFTSUSY
	...
	{
		printf("\"%s\" absent. Please check the SOFTSUSY path or comment \"#define USE_SOFTSUSY\" in cmssm.c\n",SOFTSUSY);
		filesOK=0;
	}
#endif
#ifdef USE_SUSPECT
	...
	{
		printf("\"%s\" absent. Please check the SUSPECT path or comment \"#define USE_SUSPECT\" in cmssm.c\n",SUSPECT);
		filesOK=0;
	}
#endif
#ifdef USE_SPHENO
	if(!test_file(SPHENO)) 
	{
		printf("\"%s\" absent. Please check the SPHENO path or comment \"#define USE_SPHENO\" in cmssm.c\n",SPHENO);
		filesOK=0;
	}
#endif
	if(!filesOK) return 1;
	...
	printf("---------------------------------------\n\n");
	printf("CMSSM - SLHA file generated by SOFTSUSY\n\n");
	...
	printf("---------------------------------------\n\n");
	printf("CMSSM - SLHA file generated by ISAJET\n\n");
	...
	printf("---------------------------------------\n\n");
	printf("CMSSM - SLHA file generated by SUSPECT\n\n");
	...
	printf("---------------------------------------\n\n");
	printf("CMSSM - SLHA file generated by SPHENO\n\n");
