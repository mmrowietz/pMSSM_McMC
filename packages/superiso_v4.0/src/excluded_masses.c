...
/* tests whether the SUSY point is excluded by the LEP Higgs constraints */
/* if excluded, returns 1, otherwise 0 */
{
	int excluded=0;
...
/* tests whether the SUSY point is excluded by the LEP/Tevatron constraints */
/* if excluded, returns 1, otherwise 0 */
{
	int excluded=0;
...
/* "container" function scanning the SLHA file "name" and checking if the SUSY point is excluded by the LEP Higgs mass contraints */
{
...
/* "container" function scanning the SLHA file "name" and checking if the SUSY point is excluded by the LEP/Tevatron mass contraints */
{
	struct parameters param;
...
/* "container" function scanning the SLHA file "name" and checking if the SUSY point is excluded by the LEP/Tevatron SUSY mass contraints */
{
	struct parameters param;
...
/* if the LSP is charged, returns 1, otherwise 0 */
{
	double neutral_mass;
	int charged_LSP=0;
